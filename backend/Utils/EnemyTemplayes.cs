...
namespace backend.Utils
{
    ...
    public static class EnemyTemplates
    {
        public static List<EnemyTemplate> All = new List<EnemyTemplate>
        {
            ...
            new EnemyTemplate { Name = "Chicken Jockey", MaxHp = 18, Attack = 19, Defense = 1, XP = 39, CritChance = 0.11 },
            new EnemyTemplate { Name = "Flat Haired Ivar", MaxHp = 90, Attack = 21, Defense = 0, XP = 55, CritChance = 0.11 },
            new EnemyTemplate { Name = "Magister T.", MaxHp = 158, Attack = 22, Defense = 5, XP = 101, CritChance = 0.18 },
            new EnemyTemplate { Name = "Schultz the dog", MaxHp = 56, Attack = 43, Defense = 4, XP = 74, CritChance = 0.11 },
            new EnemyTemplate { Name = "Santa Claus", MaxHp = 276, Attack = 35, Defense = 2, XP = 150, CritChance = 0.21 },
