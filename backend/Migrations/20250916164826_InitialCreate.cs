        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MissionProgressJson = table.Column<string>(type: "text", nullable: false),
                    ClaimedMissionsJson = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnspentStatPoints = table.Column<int>(type: "integer", nullable: false),
                    ...
                    MissionProgressJson = table.Column<string>(type: "text", nullable: false),
                    ClaimedMissionsJson = table.Column<string>(type: "text", nullable: false),
                    LastDailyResetJson = table.Column<string>(type: "text", nullable: false),
                    LastWeeklyResetJson = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
